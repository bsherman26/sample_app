...
#    it { should_not have_link('Profile',  href: user_path(user)) }       # I have no idea why this doesn't work
#    it { should_not have_link('Settings', href: edit_user_path(user)) }  # I have no idea why this doesn't work
